...
## Sobre mim
Tecnólogo em Banco de Dados, atuando como desenvolvedor interno no setor de emergência hospitalar.  
Experiência prática em Python, SQL e automação de processos.  
...
- SQL ANSI & VBA (MsAccess)  
- Power BI & DAX  
- Kotlin & Google Apps Script  
## 🚀 Projetos em Destaque
- [Sistema de Estoque em MsAccess](link)  
- [Pipeline de Extração de Dados (Python)](link)  
- [App Mobile de Rastreamento (Kotlin)](link)  
